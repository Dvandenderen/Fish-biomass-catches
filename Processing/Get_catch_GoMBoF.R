...
AS <- subset(subcells,subcells$ECO_REG == "Gulf of Maine/Bay of Fundy")
...
save(tot,file="C:/Users/danie/Documents/Online for git/Fish-biomass-catches/Data/Watson/GulfMaineBayFundyME.RData")
