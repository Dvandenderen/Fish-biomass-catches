...
AS <- subset(subcells,subcells$ECO_REG == "Scotian Shelf")
...
save(tot,file="C:/Users/danie/Documents/Online for git/Fish-biomass-catches/Data/Watson/ScotianShelfME.RData")
