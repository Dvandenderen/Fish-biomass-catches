...
AS <- subset(subcells,subcells$ECO_REG %in% c("Eastern Bering Sea","Aleutian Islands"))
...
save(tot,file="C:/Users/danie/Documents/Online for git/Fish-biomass-catches/Data/Watson/EBS_AI_ME.RData")
