...
AS <- subset(subcells,subcells$ECO_REG == "Northern Norway and Finnmark")
...
save(tot,file="C:/Users/danie/Documents/Online for git/Fish-biomass-catches/Data/Watson/NorwayFinnME.RData")
