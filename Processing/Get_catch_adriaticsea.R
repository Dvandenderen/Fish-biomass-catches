...
file_names <- c("Catch_all_1990_1994.rds","Catch_all_1995_1999.rds","Catch_all_2000_2004.rds",
                "Catch_all_2005_2009.rds","Catch_all_2010_2014.rds",
                "Catch_all_2015_2015.rds")

load("Cells_in_EcoReg.RData")
AS <- subset(subcells,subcells$ECO_REG == "Adriatic Sea")
...
save(tot,file="C:/Users/danie/Documents/Online for git/Fish-biomass-catches/Data/Watson/AdriaticME.RData")
